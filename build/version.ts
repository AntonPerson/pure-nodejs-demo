 ...
 */
async function readGitCommit(branch: string): Promise<string> {
 ...
 */
function readGitTimestamp(commitHash: string): string {
...
/**
 * Generate the version.generated.json file containing the current Git branch, latest commit hash, and timestamp.
 */
(async () => {
  try {
